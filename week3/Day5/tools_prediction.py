...
# Day 5 hardening: a single disclaimer string used on *every* prediction
# response (match-winner and top-player alike), so the framing guarantee in
# Task 1 ("consistent disclaimer language on all predictions") is enforced
# at the source instead of drifting between two hand-written strings.
PREDICTION_DISCLAIMER = (
    "This is a predicted probability, not a certainty — actual outcomes "
    "depend on real-time form, selection, injuries, and in-game variance."
)
